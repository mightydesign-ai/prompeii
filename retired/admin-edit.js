...
async function loadPrompt() {
  ...
  if (error || !data) { console.error(error); showToast("Error loading prompt", true); return; }
...
saveBtn.addEventListener("click", async () => {
  ...
  if (error) { console.error(error); showToast("Save failed", true); return; }
  showToast("Saved");
});
...
deleteBtn?.addEventListener("click", async () => {
  ...
  if (error) { console.error(error); showToast("Delete failed", true); return; }
...
duplicateBtn?.addEventListener("click", async () => {
  ...
  if (error) { console.error(error); showToast("Duplicate failed", true); return; }
