...
// AI buttons
document.getElementById("aiTitleBtn").addEventListener("click", () => openAIModal("Improve Title", smartTitleEl));
document.getElementById("aiIntroBtn").addEventListener("click", () => openAIModal("Improve Intro", introEl));
document.getElementById("aiPromptBtn").addEventListener("click", () => openAIModal("Improve Prompt", promptTextEl));
...
function renderMarkdown(text) {
  if (!text || text.trim() === "") return "Start typing to see preview…";
...
function buildPreviewText() {
  const title  = smartTitleEl.value.trim();
...
function updatePreview() {
  ...
  if (previewMode === "raw") { previewOutput.textContent = text || "Start typing to see preview…"; return; }
  previewOutput.innerHTML = renderMarkdown(text);
}
